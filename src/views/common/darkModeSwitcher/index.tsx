...
type DarkModeSwitcherViewLayerType = {
    colorMode: string | any
    setColorMode: any
}

export default function DarkModeSwitcherViewLayer({ colorMode, setColorMode }: DarkModeSwitcherViewLayerType) {
    return (
        <li>
            <label
